/*************************************************************************
	...
	> Author: x
	> Mail: x.com
	> Created Time: 2018年09月10日 星期一 19时30分10秒
 ************************************************************************/
...
int main() {
    ...
    while (n--) {
        ...
        int x, y;
        switch (t) {
            case 1: scanf("%d %d", &x, &y), insert(a, x, y) ? printf("success\n") : printf("failed\n"); break;
            case 2: scanf("%d", &x), delete_node(a, x) ? printf("success\n") : printf("failed\n"); break;
        	case 3: scanf("%d", &x), search(a, x) ? printf("success\n") : printf("failed\n"); break;
